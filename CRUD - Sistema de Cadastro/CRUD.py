...
from tkinter import *
from PIL import Image, ImageTk #Importando os modulos da biblioteca PIL para fazar a conversão de tipo da imagem
...
imagem_pillow = Image.open("imagens-background\\Pizzaria-4.jpg")
...
Titulo = tk.Label(Tela,text="Dados Cadastrais", fg="#000000", font=("Italic", 15, "bold")).place(x=150,y=30)
# Definindo o titulo no meio do programa
Titulo2= tk.Label(Tela,text="Funções", fg="#000000", bg=None, font=("Italic",15,"bold" )).place(x=650, y=30)

Entrada_Codigo = tk.Entry(Tela, width="10").place(x=168, y=150)
Texto_Codigo = tk.Label(Tela, text="Código:", bg=None,font="bold").place(x=100, y= 147)
...
Texto_Nome = tk.Label(Tela, text="Nome:", bg=None,font="bold").place(x=110, y= 173)
...
Texto_Endereco = tk.Label(Tela, text="Endereço:", bg=None,font="bold").place(x=85, y= 197)
...
Texto_Cep = tk.Label(Tela, text="Cep:", bg=None,font="bold").place(x=122, y= 222)
...
Texto_Telefone = tk.Label(Tela, text="Telefone:", bg=None, font="bold").place(x=92, y= 247)
...
Texto_Pedido = tk.Label(Tela, text="Pedido:", bg=None,font="bold").place(x=100, y= 275)
